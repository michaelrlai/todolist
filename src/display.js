...
const displayProjects = (function() {
    ...
    const projectsButtons = (function() { // Create and display list of projects
...
export const createProjectsList = function(tasks) {
    ...
    while (oldProjectsList.firstChild) oldProjectsList.removeChild(oldProjectsList.firstChild);
...
export const toggleProjectsList = function() { // Toggle projects list to show or hide
